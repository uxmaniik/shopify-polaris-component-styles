...
Element: `s-ordered-list`  
Docs: https://shopify.dev/docs/api/app-home/web-components/layout-and-structure/ordered-list  
Captured: 2026-05-03  
...
Use the native `s-ordered-list` component before creating custom Shopify-admin-looking UI.

## Native Examples

```tsx
<s-ordered-list data-measure="target" ><s-list-item>First item</s-list-item><s-list-item>Second item</s-list-item></s-ordered-list>
```
...
Notes: Open shadow root inspected. Measured internal ol node.
...
- Keep new wrappers thin and delegate visual behavior to `s-ordered-list`.
