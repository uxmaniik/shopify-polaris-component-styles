...
Element: `s-menu`  
Docs: https://shopify.dev/docs/api/app-home/web-components/actions/menu  
Captured: 2026-05-03  
...
Use the native `s-menu` component before creating custom Shopify-admin-looking UI.

## Native Examples

```tsx
<s-menu data-measure="target" >Menu</s-menu>
```
...
| Slot | Type | Notes |
| --- | --- | --- |
| `children` | HTMLElement | The items displayed within the menu. Only accepts button and section components. Use button for individual menu actions and section to group related items. ** |
...
- Keep new wrappers thin and delegate visual behavior to `s-menu`.
