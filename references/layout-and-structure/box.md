...
Element: `s-box`  
Docs: https://shopify.dev/docs/api/app-home/web-components/layout-and-structure/box  
Captured: 2026-05-03  
...
Use the native `s-box` component before creating custom Shopify-admin-looking UI.

## Native Examples

```tsx
<s-box data-measure="target" ><s-text>Example content</s-text><s-button>Action</s-button></s-box>
```
...
| Slot | Type | Notes |
| --- | --- | --- |
| `children` | HTMLElement | The content displayed within the box component, which serves as a flexible container for organizing and styling other components. ** |
...
First visible shadow/control rect: `{"x":32,"y":32,"width":960,"height":28}`
...
- Keep new wrappers thin and delegate visual behavior to `s-box`.
